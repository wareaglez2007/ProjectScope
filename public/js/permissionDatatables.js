$(function () {
    ...
    $('#permissions_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '/admin/permissions/getpermissions',
            ...
            [
                {
                    ...
                    "render": function (data, type, row) {
                        var view_button = '<form method="post" onsubmit="event.preventDefault();confirm(' + row.id + ');"><div style="text-align:center"><div class="btn-group"> <a href="groups/' + row.id + '/show" class="btn btn-info btn-sm">View</a>';
